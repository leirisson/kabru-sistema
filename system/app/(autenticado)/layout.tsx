        ...
        <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <form action={logout}>
              <button
                type="submit"
                className="flex items-center gap-2 rounded-lg border border-slate-200 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all"
              >
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
