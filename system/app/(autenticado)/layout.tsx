        ...
        <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-[#0A0A0A]">Kabru Sistema</span>
            </div>
            <nav className="flex gap-1">
              <Link 
                href="/dashboard" 
                className="flex items-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-[#FFD700]/10 hover:text-[#0A0A0A] transition-colors"
              >
            ...
            <div className="flex items-center gap-3 text-sm">
              <div className="flex items-center gap-3 rounded-full bg-slate-100 px-3 py-2">
                ...
                <div className="hidden sm:block">
                  <p className="text-sm font-semibold text-[#0A0A0A]">{session.nome}</p>
