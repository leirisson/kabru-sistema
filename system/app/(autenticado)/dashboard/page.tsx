  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div className="group rounded-3xl bg-white p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all dark:bg-slate-800 dark:border-slate-700">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-slate-500 dark:text-slate-400">Em Andamento</h3>
          ...
          <p className="text-4xl font-bold text-slate-900 dark:text-slate-100">{pedidos.length}</p>
        </div>

        <div className="group rounded-3xl bg-white p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all dark:bg-slate-800 dark:border-slate-700">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-slate-500 dark:text-slate-400">Concluídos Hoje</h3>
        ...
        <div className="group rounded-3xl bg-white p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all dark:bg-slate-800 dark:border-slate-700">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-slate-500 dark:text-slate-400">Total de Pedidos</h3>
          ...
          <p className="text-4xl font-bold text-slate-900 dark:text-slate-100">{totalPedidos}</p>
        </div>

        <div className="group rounded-3xl bg-white p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all dark:bg-slate-800 dark:border-slate-700">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-slate-500 dark:text-slate-400">Status Distintos</h3>
          ...
          <p className="text-4xl font-bold text-slate-900 dark:text-slate-100">{STATUS_KANBAN.length}</p>
        </div>
      </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm dark:border-slate-700 dark:bg-slate-800">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {STATUS_KANBAN.map((status) => (
                <div key={status} className="rounded-2xl border border-slate-100 bg-slate-50/50 p-5 hover:bg-slate-50 transition-colors dark:border-slate-700 dark:bg-slate-700/50 dark:hover:bg-slate-700">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm dark:border-slate-700 dark:bg-slate-800">
          ...
          <div className="space-y-4">
            {ultimosPedidos.map((pedido) => (
              <div key={pedido.id} className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50/50 hover:bg-slate-50 transition-colors dark:bg-slate-700/50 dark:hover:bg-slate-700">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-semibold text-slate-900 truncate dark:text-slate-100">{pedido.cliente.nomeFantasia || pedido.cliente.razaoSocial}</p>
