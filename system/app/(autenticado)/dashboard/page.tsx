  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-6 lg:grid-cols-4">
        <div className="group rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-xs sm:text-sm font-semibold text-slate-500">Em Andamento</h3>
          ...
          <p className="text-3xl sm:text-4xl font-bold text-[#0A0A0A]">{pedidos.length}</p>
        </div>

        <div className="group rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-xs sm:text-sm font-semibold text-slate-500">Concluídos Hoje</h3>
          ...
          <p className="text-3xl sm:text-4xl font-bold text-[#0A0A0A]">{concluidosHoje}</p>
        </div>

        <div className="group rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-xs sm:text-sm font-semibold text-slate-500">Total de Pedidos</h3>
          ...
          <p className="text-3xl sm:text-4xl font-bold text-[#0A0A0A]">{totalPedidos}</p>
        </div>

        <div className="group rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-xs sm:text-sm font-semibold text-slate-500">Taxa de Conclusão</h3>
          ...
          <p className="text-3xl sm:text-4xl font-bold text-[#0A0A0A]">{taxaConclusao}%</p>
      ...
      <div className="grid gap-3 sm:gap-6 sm:grid-cols-2">
        <div className="group rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-xs sm:text-sm font-semibold text-slate-500">Novos Pedidos Hoje</h3>
          ...
          <p className="text-3xl sm:text-4xl font-bold text-[#0A0A0A]">{novosHoje}</p>
          <p className="text-xs text-slate-400 mt-1">emitidos hoje</p>
        </div>

        <div className="group rounded-2xl sm:rounded-3xl bg-white p-4 sm:p-7 shadow-sm border border-slate-200 hover:shadow-md transition-all">
          <div className="flex items-center justify-between mb-3 sm:mb-4">
            <h3 className="text-xs sm:text-sm font-semibold text-slate-500">Novos Pedidos na Semana</h3>
          ...
          <p className="text-3xl sm:text-4xl font-bold text-[#0A0A0A]">{novosSemana}</p>
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-lg font-bold text-[#0A0A0A]">Pedidos por Vendedor</h2>
        </div>
          ...
          {pedidosPorVendedor.map((item) => {
            ...
            return (
              <div key={item.vendedorId} className="flex items-center gap-2 sm:gap-4">
                <span className="w-24 sm:w-36 truncate text-xs sm:text-sm font-medium text-slate-700">
                ...
                <span className="w-8 text-right text-sm font-bold text-[#0A0A0A]">{item._count.id}</span>
              </div>
            )
          })}
        </div>
