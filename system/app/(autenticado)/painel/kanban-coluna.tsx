  ...
  return (
    <div className="flex min-w-0 flex-col gap-3">
      ...
      <div className="flex flex-col gap-3 overflow-y-auto min-h-[200px]">
        {pedidos.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-8 rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50">
            ...
            <p className="text-sm text-slate-400 font-medium">Nenhum pedido</p>
          </div>
        ) : (
          pedidos.map((p) => (
            <PedidoCard
